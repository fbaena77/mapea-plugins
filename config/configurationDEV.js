...
(function (M) {
   ...
   * @api stable
   */
  M.config('THEME_URL', 'http://mapea4-sigc.juntadeandalucia.es/mapea/assets/');
  ...
  M.config('predefinedWMC', {
     ...
     * @api stable
     */
    'names': 'Callejero,Satelite,Hibrido,mapa callejero cache,mapa del callejero,mapa idea,mapa ortofoto09,Callejero,Ortofoto,HÃ­brido,mapa ortofoto'.split(',')
  });
