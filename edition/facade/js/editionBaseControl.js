...
M.control.Edition.prototype.createView = function (map) {
	...
	return new Promise(function (success) {
		return M.template.compile(M.control.Edition.TEMPLATE,{
			...
			this_.element_ = html;
			this_.sandBoxLayer_ = new M.impl.EditionLayer(this_);
...
M.control.Edition.prototype.createControls = function () {
	this.insertGeomControl = new M.control.EditionInsertGeometry(this.facadeMap_, this.sandBoxLayer_);
	this.modifyGeomControl = new M.control.EditionModifyGeometry(this.facadeMap_, this.sandBoxLayer_);
	this.insertTemporalGeomControl = new M.control.EditionTemporalGeometry(this.facadeMap_, this.sandBoxLayer_);
	this.translateGeomControl = new M.control.EditionTranslateGeometry(this.facadeMap_, this.sandBoxLayer_);
	this.selectGeomControl = new M.control.EditionSelectGeometry(this.facadeMap_, this.sandBoxLayer_);
	this.highlightControl = new M.control.EditionHighlightGeometry(this.facadeMap_, this.sandBoxLayer_);
	this.snappingControl = new M.control.EditionSnapping(this.facadeMap_, this.sandBoxLayer_);
...
M.control.Edition.prototype.addFeaturesToSandbox = function (geoJsonfeaturesArray) {
	this.sandBoxLayer_.addFeaturesToSandBox(geoJsonfeaturesArray);	
};
