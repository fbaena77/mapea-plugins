goog.provide('P.control.WFSManagerAddFolderControl');
...
/**
 * @classdesc
 * Main constructor of the class. Creates a WFSManagerAddFolderControl
 * control
 *
 * @constructor
 * @extends {M.Control}
 * @api stable
 */
M.control.WFSManagerAddFolderControl = (function (config, callback) {
	/**
 ...
 * @api stable
 */
M.control.WFSManagerAddFolderControl.prototype.createView = function () {
	var this_ = this;
	this.panel_ = new M.control.WFSManagerPanelControl();
	var config = this.config_;
	return Promise.resolve(this.panel_.createView()).then(function(){
		return new Promise(function (success) {
			M.template.compile(M.control.WFSManagerAddFolderControl.TEMPLATE,{
				'jsonp': false,
				'vars': config,
				'parseToHtml': true
			}).then(function (html) {
 ...
 * @api stable
 */
M.control.WFSManagerAddFolderControl.prototype.addEvents = function (html) {
	this.element_ = html;
 ...
 * @api stable
 */
M.control.WFSManagerAddFolderControl.prototype.addFolder = function (evt) {
 ...
 * @api stable
 */
M.control.WFSManagerAddFolderControl.prototype.createPanelInfo = function (html) {
 ...
 * @api stable
 */
M.control.WFSManagerAddFolderControl.prototype.close = function () {
 ...
 * @api stable
 */
M.control.WFSManagerAddFolderControl.prototype.equals = function (obj) {
	var equals = false;
	if (obj instanceof M.control.WFSManagerAddFolderControl) {
 ...
 * @api stable
 */
M.control.WFSManagerAddFolderControl.NAME = 'WFSManagerAddFolderControl';
...
M.control.WFSManagerAddFolderControl.TEMPLATE = 'WFSManagerAddFolder.html';
if(M.config.devel){
	M.control.WFSManagerAddFolderControl.TEMPLATE = 'src/WFSManager/templates/WFSManagerAddFolder.html';
}
