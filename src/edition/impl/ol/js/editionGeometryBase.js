goog.provide('P.impl.control.EditionGeometryBase');
 ...
 * @api stable
 */
M.impl.control.EditionGeometryBase = function(map, layer) {
	/**
...
goog.inherits(M.impl.control.EditionGeometryBase, M.impl.Control);
 ...
 * @api stable
 */
M.impl.control.EditionGeometryBase.prototype.addTo = function(map, element) {
 ...
 */
M.impl.control.EditionGeometryBase.prototype.activate = function(callback, idFeature, entityLayer) {
 ...
 * @api stable
 */
M.impl.control.EditionGeometryBase.prototype.deactivate = function() {
 ...
 * @api stable
 */
M.impl.control.EditionGeometryBase.prototype.destroy = function() {
