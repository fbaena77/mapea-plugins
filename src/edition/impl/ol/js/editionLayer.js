goog.provide('P.impl.EditionLayer');
...
(function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer= (function (base) {
		/**
		 * Type of the layer
		 * @private
		 * @type {String}
	...
	goog.inherits(M.impl.EditionLayer, M.impl.Layer);
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.addTo = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.selectableStyle = function (style) {
		var this_ = this;
		return function() {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getType = function () {
		return 'MultiPolygon';
	};
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getImplLayer = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getImplFeature = function (Mfeature) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getFeatureCollectionById = function (idFeature) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getFeatureCollection = function () {
		var features = this.ol3Layer_.getSource().getFeatures();
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getSelectedFeatureCollection = function () {
		var features = [];
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getOLFeatures = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getFeatures = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.addFeatures = function (features) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.hasGeometry = function () {
		var features = this.ol3Layer_.getSource().getFeatures();
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getGeometry = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getCoordinatesFromFeature = function (feature) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getCoordinatesFromFeatureById = function (idFeature) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.readGML3Features = function (gmlText) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.addFeature = function (olFeature) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.removeFeatureById = function (featureId) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.removeFeature = function (MFeature) {
		var this_ = this;
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.removeAllFeatures = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.addFeaturesToSandBox = function (featuresArray) {
		var this_ = this;
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.addNewFeatureToSandBox = function (olFeature) {
		var geojsonFormat = new ol.format.GeoJSON();
		var jsonFeature = geojsonFormat.writeFeatureObject(olFeature);
		var newFeature = new M.Feature(olFeature.getId(), jsonFeature);
		this.sandBoxLayer_.addFeatures(newFeature);
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.removeFeaturesFromSandBox = function (featuresArray) {		
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.selectFeature = function (olFeature) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.unselectFeature = function (olFeature) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.selectAllFeatures = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.unselectAllFeatures = function () {
		var allFeatures = this.sandBoxLayer_.getFeatures();
		for(let i=0;i<allFeatures.length;i++){
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getGeometriesExtension = function () {
		var features = this.ol3Layer_.getSource().getFeatures();
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getOLFeaturesExtensionByAttribute = function (featuresIdArray, attribute) {
		var foundFeatures = [];
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getOLFeaturesExtension = function (Mfeatures) {
		var olFeatures = [];
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.zoomToLayer = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.zoomToFeatures = function (Mfeatures) {
		try{
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.zoomToFeaturesByIdsArray = function (featuresIdArray, attribute) {
		try{
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.zoomToFeatureById = function (featureId) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getMFeatureByUniqueAttribute = function (value, attr) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getFeatureById = function (featureId) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getOLFeatureByUniqueAttribute = function (value, attr) {
		let foundFeature = null;
		if (this.ol3Layer_.getSource().getFeatures().length > 0) {
			var features = this.ol3Layer_.getSource().getFeatures();
			features.forEach(function(f, index, array){
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getDeletedFeatures = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.clearDeletedFeaturesArray = function () {
		this.deletedFeatures_ = [];
	};
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.rollbackFeatures = function (clonedFeatures) {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.clear = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.refresh = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.destroy = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getSandBoxStyle = function () {
	 ...
	 * @api stable
	 */
	M.impl.EditionLayer.prototype.getSelectedStyle = function () {
		return new ol.style.Style({
			fill: new ol.style.Fill({ 
				color: [249, 232, 6, 0.1]
			}),
